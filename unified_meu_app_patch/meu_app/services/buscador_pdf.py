...
class BuscadorPDF:
    """Primeiro consulta o índice local de PDFs; se insuficiente, usa Tavily (se disponível)."""
    ...
    def __init__(
        ...
        # tenta carregar; se não existir, indexa e carrega
    ...
    def buscar_resposta(self, problema: str) -> str:
        ...
        # Complemento com Tavily (se configurado)
        if self.tavily:
    ...
    # Novo: para o ConversorPropostas usar como contexto
