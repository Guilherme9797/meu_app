...
kv RAG_MIN_CHUNK_SCORE "${RAG_MIN_CHUNK_SCORE:-0.3}"
kv RAG_PER_DOC_CAP     "${RAG_PER_DOC_CAP:-3}"
kv RAG_MMR_LAMBDA      "${RAG_MMR_LAMBDA:-0.6}"
...
echo -e "  ${CYAN}python run_server.py${RESET}"
echo -e "• Subir com ngrok (2 terminais):"
echo -e "  ${CYAN}python run_server.py${RESET}  # terminal 1"
